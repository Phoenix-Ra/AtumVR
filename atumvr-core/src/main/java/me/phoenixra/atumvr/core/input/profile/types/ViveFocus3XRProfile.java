...
import static me.phoenixra.atumvr.api.input.profile.types.ViveFocus3Profile.*;
...
@Getter
public class ViveFocus3XRProfile extends XRInteractionProfile {
    private static final VRInteractionProfileType PROFILE = VRInteractionProfileType.VIVE_FOCUS3;
    ...
    private BoolButtonMultiAction gripTouch;
    ...
    public ViveFocus3XRProfile(XRProvider vrProvider) {
        super(vrProvider, "vive_focus3", "Vive Focus 3 Controller", 0);
    }
    ...
    protected List<XRAction> loadActions(@NotNull XRProvider vrProvider) {
        ...
        gripButton = new BoolButtonMultiAction(
                vrProvider, this,
                new VRActionIdentifier("button.grip.click"), "Grip Button",
                List.of(
                        new BoolButtonMultiAction.SubActionBoolButton(
                                BUTTON_GRIP_CLICK_LEFT,
                                LEFT_HAND_PATH,
                                false
                        ).putDefaultBindings(PROFILE, "input/squeeze/click"),
                        new BoolButtonMultiAction.SubActionBoolButton(
                                BUTTON_GRIP_CLICK_RIGHT,
                                RIGHT_HAND_PATH,
                                false
                        ).putDefaultBindings(PROFILE, "input/squeeze/click")
                )
        ...
        gripTouch = new BoolButtonMultiAction(
                vrProvider, this,
                new VRActionIdentifier("button.grip.touch"), "Grip Touch",
                List.of(
                        new BoolButtonMultiAction.SubActionBoolButton(
                                BUTTON_GRIP_TOUCH_LEFT,
                                LEFT_HAND_PATH,
                                false
                        ).putDefaultBindings(PROFILE, "input/squeeze/touch"),
                        new BoolButtonMultiAction.SubActionBoolButton(
                                BUTTON_GRIP_TOUCH_RIGHT,
                                RIGHT_HAND_PATH,
                                false
                        ).putDefaultBindings(PROFILE, "input/squeeze/touch")
                )
        ...
        listButton.addAll(gripTouch.getSubActionsAsButton());
        ...
        return List.of(
                ...
                gripValue, gripButton, gripTouch,
                triggerValue, triggerButton, triggerTouch,
