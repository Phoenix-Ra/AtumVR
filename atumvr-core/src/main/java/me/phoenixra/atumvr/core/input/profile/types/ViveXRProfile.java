...
import static me.phoenixra.atumvr.api.input.profile.types.ViveProfile.*;
...
@Getter
public class ViveXRProfile extends XRInteractionProfile {
    ...
    public ViveXRProfile(XRProvider vrProvider) {
