 ...
 */
@Getter
public abstract class VRSingleAction<T> extends VRAction {
    ...
    public VRSingleAction(VRProvider vrProvider,
    ...
    protected abstract void onInit(VRActionSet actionSet,
                                   MemoryStack stack);
    ...
    public VRSingleAction<T> putDefaultBindings(@NotNull VRInteractionProfileType profile,
                                                @Nullable String source){
        defaultBindings.put(profile, source);
        return this;
    }
    public VRSingleAction<T> putDefaultBindings(@NotNull List<VRInteractionProfileType> profiles,
                                                @Nullable String source){
