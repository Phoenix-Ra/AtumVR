...
import static me.phoenixra.atumvr.api.input.profile.types.ViveCosmosProfile.*;
...
@Getter
public class ViveCosmosXRProfile extends XRInteractionProfile {
    ...
    public ViveCosmosXRProfile(XRProvider vrProvider) {
