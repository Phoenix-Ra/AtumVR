...
public abstract class VRActionSet {
    ...
    @Getter
    private List<VRAction> actions = new ArrayList<>();


    public VRActionSet(@NotNull VRProvider vrProvider,
                       @NotNull String name,
     ...
     */
    protected abstract List<VRAction> loadActions(@NotNull VRProvider vrProvider);
     ...
     */
    public List<PairRecord<VRAction, String>> getDefaultBindings(@NotNull VRInteractionProfileType profile){
        List<PairRecord<VRAction, String>> out = new ArrayList<>();
        for(VRAction action : actions){
            if(action instanceof VRSingleAction<?> singleAction){
            ...
            }else if(action instanceof VRMultiAction<?> multiAction){
                for(VRMultiAction.SubAction<?> subAction : multiAction.getSubActions()){
