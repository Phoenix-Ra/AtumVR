...
public class XRUtils {
    ...
    @Nullable
    public static XrSpaceLocation xrLocationFromSpace(@NotNull XRProvider vrProvider,
    ...
    public static XrSpace createReferenceSpace(@NotNull XRProvider vrProvider,
                                               int spaceType,
