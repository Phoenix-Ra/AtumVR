package me.phoenixra.atumvr.api.provider.openvr;
...
public class OpenVRCamera implements VRCamera {
    ...
    public OpenVRCamera(VRProvider vrProvider, Vector3f location, Quaternionf rotation){
    ...
    public void setupViewMatrix(EyeType eyeType, MemoryStack stack) {
        ...
        viewMatrix = eyeToHead.mul(
                vrProvider.getDevicesManager().getHMD()
