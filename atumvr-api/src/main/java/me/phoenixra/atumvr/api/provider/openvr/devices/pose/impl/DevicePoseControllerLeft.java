...
public class DevicePoseControllerLeft implements DevicePoseMatch {
    @Override
    public boolean isMatching(@NotNull VRDevice vrDevice) {
        ...
        Vector3f left = new Vector3f(-1, 0, 0); // Down direction in world space

        /*Vector3f transformedForward = AtumQuaternion.rotateVector(forward,devicePosition);

        return transformedForward.dot(left) > 0.8;*/
        return false;
    }
}
