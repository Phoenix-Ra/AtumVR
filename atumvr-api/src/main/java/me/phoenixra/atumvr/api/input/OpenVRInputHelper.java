...
public class OpenVRInputHelper {

    public static long getInputActionHandle(@NotNull String actionPath,
    ...
    public static long getInputActionSetHandle(@NotNull String actionSetPath,
                                        @NotNull MemoryStack stack) throws VRInputException{
        LongBuffer result = stack.mallocLong(1);
    ...
    public static long getInputSourceHandle(@NotNull String path,
                                     @NotNull MemoryStack stack) throws VRInputException{
        LongBuffer result = stack.mallocLong(1);
    ...
    public static List<Long> getActionOrigins(String actionSet,
                                       long handle,
                                       String nameForLog,
    ...
    public static InputDigitalData getDigitalData(long controllerHandle,
                                           long actionHandle,
    ...
    public static InputAnalogData getAnalogData(long controllerHandle,
                                         long actionHandle,
                                         @NotNull String nameForLog,
                                         @NotNull MemoryStack stack) {
    ...
    public static InputOriginDeviceInfo getOriginInfo(long actionHandle,
                                               @NotNull MemoryStack stack) {
